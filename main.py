...
def sendEmail(to, content):
    try:
        ...
        server.login('mishratwinkle776@gmail.com', 'mdjn tabh yxgt qssd') # Login to the email account 
        server.sendmail('mishratwinkle776@gmail.com', to, content) # Send the email
